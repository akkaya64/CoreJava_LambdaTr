...
public class C03Lists {
    public static void main(String[] args) {
        ...
        //Arrays.asLıst ıle Lıst olusturalabılır ama
        // Lıstlerdekı eleman sayısını degıstıren hıcbır method bu Lıst ıcın kullanılamaz
        //Dolayısıyla bu sorunun cozumunde ıhtıyacınız olan Lıstı Arrays.asLıst kullanarak olusturmamalısınız
