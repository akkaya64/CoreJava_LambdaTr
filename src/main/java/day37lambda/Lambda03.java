...
public class Lambda03 {
    public static void main(String[] args) {
        ...
        //2)Kurs isimlerinden en az birinin "Turkish" içerip içermediğini kontrol eden kodu yazınız
        boolean result2 = coursesList.
                stream().
                anyMatch(t -> t.getCourseName().//en az biri diyor bu kurs ismini al
                        contains("Turkish"));//turkish içeriyor mu
        System.out.println(result2);

        //3)Average score'u en yuksek olan kursun ismini konsola yazdıran kodu yazınız.
        ...
        // 6 - Tum course object'lerini average score'a gore "kucukten buyuge diziniz " ve 3.yü console'a yazdiriniz.
