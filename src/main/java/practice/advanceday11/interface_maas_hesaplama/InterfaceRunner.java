package practice.advanceday11.interface_maas_hesaplama;
...
public class InterfaceRunner {
    ...
    Maaş kriterleri: Çalışanın toplam çalışma yılına göre her yıl için brüt maaşı 100 dolar  artır.
                     ...
                     10 yıl ve üstü çalışma yılı bulunan çalışanların brüt maaşlarından %30,
                     diğerlerinden %20 vergi kesintisi yap.
     */

    public static void main(String[] args) {
        MaasHesapla maasHesaplaAli = new MaasHesapla();
        System.out.println("maasHesaplaAli.netMaas(10000,11,1660) = " +
                maasHesaplaAli.netMaas(10000, 11, 1660));


        MaasHesapla maasHesaplaVeli = new MaasHesapla();
        System.out.println("maasHesaplaVeli.netMaas(10000,1,180) = " +
                maasHesaplaVeli.netMaas(10000, 1, 180));

        MaasHesapla maasHesaplaAyse = new MaasHesapla();
        System.out.println("maasHesaplaAyse.netMaas(10000,15,180) = " +
                maasHesaplaAyse.netMaas(10000, 15, 180));
    }
